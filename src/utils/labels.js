...
// สีของป้ายสถานะ — ต้องอ่านจากค่า status ตัวเดียวกับข้อความเสมอ
//
// เดิมหน้าสินค้าคงคลังคำนวณสีเองจาก "คงเหลือ > 20" ซึ่งเป็นเลขที่ฝังตายไว้
// ส่วนข้อความมาจากเซิร์ฟเวอร์ที่เทียบกับจุดสั่งซื้อของสินค้าแต่ละตัว
// สองกติกานี้ไม่ตรงกัน ทำให้สินค้า 32 ตัวขึ้นคำว่า "เบิกได้" แต่ติดสีส้ม
// เหมือนมีปัญหา ทั้งที่ของยังพอใช้ — รวมมาไว้ที่เดียวเพื่อไม่ให้หลุดอีก
export const stockStatusTone = (status) => ({
